 ...
 */
public class JSChooseWXAuthPay {
    ...
    private JSChooseWXAuthPay(int timestamp, String noncestr, String packageStr, String signType, String paySign) {
    ...
    public static class Builder {
         ...
         */
        public JSChooseWXAuthPay build() throws CryptoException {
            String sign = signType.sign(
                    MapBuilder.<String, String>build()
                            ...
                            .p("url", url),
                    null);
            return new JSChooseWXAuthPay(timestamp, noncestr, packageSrt, signType.signType().name(), sign);
        }
    }
}
